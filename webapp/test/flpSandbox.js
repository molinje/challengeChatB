		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BASF Chat",
									"targetURL": "#molinjebasfchat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"molinjebasfchat-display": {
								"semanticObject": "molinjebasfchat",
								"action": "display",
								"description": "BASF Chat",
								"title": "BASF Chat",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=molinje.basfchat",
									"url": sap.ui.require.toUrl("molinje/basfchat")
								}
							}
						}
					}
